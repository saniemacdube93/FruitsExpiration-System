<!DOCTYPE html>
<%@page import="nust.systems.workingcrud.Expired" %>
...
<i class="icofont icofont-home"></i>
    ...
    <form   action="${pageContext.request.contextPath}/ModalController10">
<div class="page-body">
<div class="row">
<div class="col-sm-28">
...
<input type="submit" value="Notify Customers" class="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger">
    
<h5>Items About to Expire</h5>
...
<tr>
       ...
       <c:forEach  items="${expired}" var="expired" >  
                     
      <td class="pro-list-img">
<img src="assets/images/light-box/sl3.jpg" class="img-fluid" alt="tbl">
</td>
   <td>   <h6 class="to"><c:out value="${expired.batchNo}" /></h6>   </td>  
             <td>   <h6 class="to"><c:out value="${expired.productDescription}" /></h6>   </td>
       
          <td>   <h6 class="to"><c:out value="${expired.productPrice}" /></h6>   </td>
           <td>   <h6 class="to"><c:out value="${expired.dayday}" /></h6>   </td>       
            <td>   <h6 class="to"><c:out value="${expired.purchaseDate}" /></h6>   </td>
              <td>   <h6 class="to"><c:out value="${expired.currentdate}" /></h6>   </td>
            <td>   <h6 class="to"><c:out value="${expired.expiryDate}" /></h6>   </td>
             <td>   <h6 class="to"><c:out value="${expired.days}" /></h6>   </td>
</tr>
