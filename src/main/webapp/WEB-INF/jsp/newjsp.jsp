...
<li class="breadcrumb-item"><a href="#!">Product List</a>
    ...
    <form   action="${pageContext.request.contextPath}/ModalController9">
<div class="page-body">
<div class="row">
<div class="col-sm-28">
...
<tr></tr>
<input type="submit" value="About to Expire" class="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger">
</button> 


<!--
<button type="button" class="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13"> <i class="icofont icofont-plus m-r-5"></i>  Expired Goods
</button>
-->

<!--
<button type="button" class="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13"> <i class="icofont icofont-plus m-r-5"></i>  Add Goods
</button>
-->
...
<table id="e-product-list" class="table table-striped">
<thead>
<tr>
<th>Image</th>
<th>Batch No</th>
...
<img src="assets/images/light-box/sl3.jpg" class="img-fluid" alt="tbl">
</td>
           <td>   <h6 class="to"><c:out value="${products.batchno}" /></h6>   </td>      
            <td>   <h6 class="to"><c:out value="${products.productDescription}" /></h6>   </td>  
          <td>   <h6 class="to"><c:out value="${products.categoryId}" /></h6>   </td>  
          <td>   <h6 class="to"><c:out value="${products.productPrice}" /></h6>   </td>
            <td>   <h6 class="to"><c:out value="${products.purchaseDate}" /></h6>   </td>
            <td>   <h6 class="to"><c:out value="${products.expiryDate}" /></h6>   </td>
</tr>
