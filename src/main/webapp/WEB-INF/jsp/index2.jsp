...
<form class="md-float-material" action="${pageContext.request.contextPath}/ModalController3">
...
<p class="text-inverse text-left m-b-15 f-16"><b>Welcome <br /> Please select your email address.</b></p>
<p class="text-inverse text-left m-b-0">Welcome to our website. Really Exciting to have you here!</p>


<div class="row m-t-15">
<div class="col-md-12">
<button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center">View Items</button>
</div>
</div>    
<div class="row m-t-15">
<div class="col-md-12">
    <input type="submit" value="Capture" class="btn btn-primary btn-md btn-block waves-effect text-center">
    </input>
</div>
</div>
<div class="row">
